!(async function () {
  ...
  const CONST = {
    ...
    gsheet: {
      id: window.gsheetData.documentId,
      name: window.gsheetData.sheetName,
    }
  };
  ...
  function HtmlTemplate_Sfida(scoreItem) {
    return `
      <section
        ...
        style="
          background-image: url('assets/${CONST.gsheet.id}/webp/${scoreItem.id}-cover.webp');
      ...
      >
        ...
        <header class="text-center">
          <img class="scoreitem-img"
            src="assets/${CONST.gsheet.id}/webp/${scoreItem.id}-title.webp" onerror="onImageLoadError(this)" loading="lazy" alt= " " />
        </header>
        ...
        <footer class="text-center mt1">
          <img class="scoreitem-img"
            src="assets/${CONST.gsheet.id}/webp/${scoreItem.id}-screen.webp" onerror="onImageLoadError(this)" loading="lazy" alt= " " />
        </footer>
      </section>
    `
  }
